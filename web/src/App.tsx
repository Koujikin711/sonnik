...
function About({ catalog }: { catalog: Catalog }) {
  ...
  return (
    <section className="about">
      ...
      <h3>Сонник</h3>
      <p>
        Содержит толкования различных образов и символов, встречающихся во снах. Здесь можно узнать
        возможное значение сновидений, связанных с семьёй, любовью, событиями, чувствами, жизненными
        ситуациями, исламскими образами и другими распространёнными символами.
      </p>
      <p>
      ...
      <h3>Тело</h3>
      <p>
        Раздел о психосоматике и взаимосвязи эмоционального состояния с телесными ощущениями. Он
        помогает посмотреть на различные симптомы и сигналы организма с точки зрения возможного
        влияния стресса, эмоционального напряжения, переживаний и психологических факторов.
      </p>
      <p>
      ...
      <p className="disclaimer">
        Важно: информация в приложении носит ознакомительный характер. Толкование сновидений не
        является предсказанием будущего, а информация в разделе «Тело» не является медицинским
        диагнозом и не заменяет консультацию врача или другого квалифицированного специалиста.
      </p>
      <p className="meta">
