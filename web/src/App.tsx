...
function About({ catalog }: { catalog: Catalog }) {
  ...
  return (
    <section className="about">
      <h2>О приложении</h2>
      <p className="about-lead">Один сонник на все слои: увидел так — к этому.</p>
      <p>
        Общий, народ, ислам, любовь, семья. Смыслы — общие традиции (примета и та‘бир), не копия
        чужих сайтов и книг. В исламе номер хадиса — только если образ есть у Пророка ﷺ.
      </p>
      <p>«Тело» — жесты днём, не примета.</p>
